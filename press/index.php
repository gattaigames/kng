...
if( file_exists('images/logo_white.png') ) {
	echo '<div class="uk-width-medium-1-2"><a href="images/logo.png"><img src="images/logo_white.png" alt="logo" /></a></div>';
}
